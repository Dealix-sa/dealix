...
def test_sk_live_key_alone_does_not_unlock(restore_env):  # pragma: allowlist secret
...
def test_sk_live_AND_explicit_allow_flag_still_blocked(restore_env):  # pragma: allowlist secret
