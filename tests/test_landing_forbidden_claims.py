...
ALLOWLIST: dict[str, dict[str, str]] = {
    ...
    # Diagnostic intake — "صفر cold outreach" promise. Disclaimer at footer:
    # "Estimated outcomes are not guaranteed outcomes / النتائج التقديرية
    # ليست نتائج مضمونة". Pure NEGATION throughout.
    "diagnostic.html": {
        "cold": "NEGATION",
        "guaranteed": "NEGATION",
        "مضمون": "NEGATION",
    ...
    # disclaimer in customer-pages section: "Estimated outcomes are not
    # guaranteed outcomes / النتائج التقديرية ليست نتائج مضمونة".
    ...
    # All pages below carry the bilingual disclaimer
    # "Estimated outcomes are not guaranteed outcomes /
    #  النتائج التقديرية ليست نتائج مضمونة" — pure NEGATION,
    # mirrors the disclaimer pattern on roi.html / terms.html.
    "architecture.html": {
        "guaranteed": "NEGATION",
        "مضمون": "NEGATION",
    },
    ...
    # Data-to-Revenue pack — also carries "صفر cold WhatsApp / LinkedIn"
    # and "لا scraping. لا إرسال آلي" in the safety section. All NEGATION.
    "data-pack.html": {
        "cold": "NEGATION",
        "guaranteed": "NEGATION",
        "scraping": "NEGATION",
    ...
    # Pure NEGATION: describes what is explicitly blocked.
    "roadmap.html": {
        "scraping": "NEGATION",
    },
    ...
    # Case-study page — "7-day money-back guarantee" appears in the refund
    # offer paragraph. Same refund-language pattern as roi.html — needs
    # founder review to either keep, qualify, or rephrase.
