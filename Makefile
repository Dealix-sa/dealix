...
.PHONY: help install install-dev setup test test-unit test-integration \
        ...
        v5-proof-pack v10-verify v10-reference founder-console-v3 \
        founder-console-v3-static
...
# ── Founder Console v3 ─────────────────────────────────────────
founder-console-v3-static: ## Founder Console v3: static file + router check (no build)
	$(PYTHON) scripts/verify_founder_console_v3.py --skip-build

founder-console-v3: ## Founder Console v3: static check + apps/web build
	$(PYTHON) scripts/verify_founder_console_v3.py
