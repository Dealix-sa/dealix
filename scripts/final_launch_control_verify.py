#!/usr/bin/env python3
"""Aggregate verifier: final launch control tower across V10 layers.
...
Run: python scripts/final_launch_control_verify.py [--strict]
"""
...
LABEL = "FINAL_LAUNCH_CONTROL"
JSON_OUT = "outputs/v10_verification/final_launch_control_verify.json"
