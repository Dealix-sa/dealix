"""Reject an outreach draft. NO send.

Usage:
    python3 scripts/reject_outreach_draft.py --draft-id draft-demo-acc-001-ar --reviewer Sami --reason "Too generic"
"""
...
def main() -> int:
    ...
    print(f"rejected {args.draft_id} by {args.reviewer}: {args.reason}")
    return 0
