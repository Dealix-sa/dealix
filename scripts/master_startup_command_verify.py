#!/usr/bin/env python3
"""Aggregate verifier: master startup command center across V10 layers.
...
Run: python scripts/master_startup_command_verify.py [--strict]
"""
...
LABEL = "MASTER_STARTUP_COMMAND"
JSON_OUT = "outputs/v10_verification/master_startup_command_verify.json"
