...
if __name__=='__main__':
    ...
    a=ap.parse_args(); rec={'incident_id':'agent_inc_'+uuid.uuid4().hex[:10], 'severity':a.severity, 'summary':a.summary, 'owner':a.owner, 'created_at':datetime.now(UTC).isoformat(), 'status':'open'}
