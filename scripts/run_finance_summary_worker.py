#!/usr/bin/env python3
"""Refresh the finance summary snapshot."""
...
def main() -> int:
    ...
    cache_path = root / "founder" / "finance_summary.json"

    try:
        from api.internal.runtime_reader import finance_summary  # type: ignore
    ...
    print(f"[run_finance_summary_worker] status={status}")
