#!/usr/bin/env python3
"""Aggregate verifier: company utilization across all V10 operating systems.
...
Run: python scripts/company_utilization_verify.py [--strict]
"""
...
LABEL = "COMPANY_UTILIZATION"
JSON_OUT = "outputs/v10_verification/company_utilization_verify.json"
