"""Verify the Dealix Master File Tree exists.

Checks that every required top-level operating folder and core file is present.
This is the structural verifier — it does not check content quality (see
`verify_document_quality.py` and `verify_company_os_deep.py` for that).
"""
...
def main() -> int:
    ...
    print("PASS: Dealix master tree is complete.")
    return 0
