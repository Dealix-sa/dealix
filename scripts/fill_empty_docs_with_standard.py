"""Dealix empty doc filler.

Walks the documented operating folders and replaces any empty markdown
files with a minimum-viable template that satisfies the Dealix Document
Standard. Files with existing content are not modified.
