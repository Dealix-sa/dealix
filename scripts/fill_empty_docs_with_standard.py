"""Fill every empty .md file under the Dealix doc tree with the standard template.

Only touches files whose size is exactly 0 bytes. Existing content is never modified.
Run locally, commit the result. Do not run inside CI as a write step against the repo;
CI should only verify.
"""
