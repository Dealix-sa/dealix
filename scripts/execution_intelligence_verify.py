#!/usr/bin/env python3
"""Aggregate verifier: execution intelligence across V10 layers.
...
Run: python scripts/execution_intelligence_verify.py [--strict]
"""
...
LABEL = "EXECUTION_INTELLIGENCE"
JSON_OUT = "outputs/v10_verification/execution_intelligence_verify.json"
