#!/usr/bin/env python3
"""Verify the Dealix V10 enterprise_sales_room OS: docs present, marker present, no forbidden claims.

Run: python scripts/enterprise_sales_room_verify.py [--strict]
