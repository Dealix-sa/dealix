"""Dealix 24/7 Growth Factory - 4 hour runner.

Routes replies, generates sample tasks, schedules follow-ups, and
refreshes acquisition reports. No external sending.
"""
