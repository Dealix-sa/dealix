...
export const metadata: Metadata = {
  title: 'Consulting, Training & B2B Services — Dealix',
  description: 'Dealix for Consulting, Training & B2B Services: review-only AI ops that reduce manual work. Tighten pipeline, proposal turnaround, and engagement reporting.',
};

export default function Page() {
  return (
    <main className="grid" style={{ maxWidth: 880, margin: "0 auto", padding: "2rem 1rem", lineHeight: 1.6 }}>
      <h1>Consulting, Training & B2B Services</h1>
      <p dir="rtl" lang="ar">الاستشارات والتدريب وخدمات الأعمال</p>
      <p>Tighten pipeline, proposal turnaround, and engagement reporting.</p>
