...
export const metadata: Metadata = {
  title: 'Facilities Management & Maintenance — Dealix',
  description: 'Dealix for Facilities Management & Maintenance: review-only AI ops that reduce manual work. Reduce manual work-order triage and SLA reporting across multiple sites.',
};

export default function Page() {
  return (
    <main className="grid" style={{ maxWidth: 880, margin: "0 auto", padding: "2rem 1rem", lineHeight: 1.6 }}>
      <h1>Facilities Management & Maintenance</h1>
      <p dir="rtl" lang="ar">إدارة المرافق والصيانة</p>
      <p>Reduce manual work-order triage and SLA reporting across multiple sites.</p>
