...
export const metadata: Metadata = {
  title: 'Real Estate & Property Operations — Dealix',
  description: 'Dealix for Real Estate & Property Operations: review-only AI ops that reduce manual work. Streamline tenant requests, lease tracking, and owner reporting.',
};

export default function Page() {
  return (
    <main className="grid" style={{ maxWidth: 880, margin: "0 auto", padding: "2rem 1rem", lineHeight: 1.6 }}>
      <h1>Real Estate & Property Operations</h1>
      <p dir="rtl" lang="ar">العقارات وعمليات الأملاك</p>
      <p>Streamline tenant requests, lease tracking, and owner reporting.</p>
