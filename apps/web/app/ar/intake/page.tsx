...
const channels = [
  {
    icon: "💬",
    title: "واتساب مباشر",
    desc: "الأسرع. تواصل مع المؤسس مباشرة وسنأخذ البيانات خلال محادثة قصيرة.",
    action: "راسل على واتساب",
  ...
  },
  {
    icon: "📞",
    title: "مكالمة مباشرة",
    desc: "نحدد موعد Zoom قصير (20 دقيقة) نأخذ فيه كل البيانات بشكل تفاعلي.",
    action: "احجز موعد",
    style: "border border-white/20 hover:bg-white/10",
    href: "#calendar",
  },
      ...
      <section className="border-t border-white/5 bg-white/[0.02] py-16" id="form">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mt-4 text-lg text-slate-300">
            أسرع طريقة — أرسل رسالة واتساب بهذه المعلومات:
          </p>

          <div
            className="mt-8 rounded-3xl border border-emerald-400/20 bg-emerald-400/[0.04] p-6 text-right"
            dir="rtl"
          >
