...
RESPONSE_TEMPLATES: dict[str, dict[str, Any]] = {
    ...
    "ask_price": {
        "ar": "سبرنت إثبات الإيرادات: 7 أيام بـ 499 ريال — استرداد كامل 100% خلال 14 يوم. "
              "بعد السبرنت: عمليات النمو الشهرية 2,999 ريال/شهر، أو إضافة دعم العمليات 1,500 ريال/شهر، "
              "أو غرفة قيادة الإدارة 7,500 ريال/شهر. تبغوا نوضح بمكالمة 20 دقيقة؟",
        "auto_send_allowed": False,
