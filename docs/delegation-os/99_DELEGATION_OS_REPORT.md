# Delegation OS — Report / Delegation OS — تقرير

> **Purpose (EN):** Status report for Delegation OS.
>
> **الغرض (AR):** تقرير حالة لـ Delegation OS.
...
- Run `python scripts/delegation_verify.py` for the machine-readable result.
