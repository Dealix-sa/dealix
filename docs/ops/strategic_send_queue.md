...
**Follow-up +3:** "تذكير مع case-safe pattern من تاجر سعودي يستخدم Dealix — أرسله؟"
**Follow-up +10:** "آخر متابعة — مستعد أقدم 7-Day Revenue Proof Sprint لأول تاجر نختاره مع فريقكم."
...
اقتراح: Dealix (رادار عمليات الإيراد المحكوم بالعربي) يصير app داخل Zid marketplace — التاجر يفعّله بضغطة، يجهّز مسودات ردود على leads جاهزة لموافقته، Zid تأخذ commission.
...
Wafeq يحل مشكلة حقيقية: فواتير ZATCA-compliant للشركات السعودية. Dealix يحل مشكلة ثانية: تجهيز مسودات ردود ومتابعات على leads بالعربي جاهزة لموافقة صاحب العمل.

الفكرة: تكامل مباشر — Dealix يقفل deal → invoice يُنشأ تلقائياً في Wafeq → العميل يدفع → confirmation في CRM.

هذا بيفيد:
1. عملاء Wafeq: يصير عندهم رادار عمليات إيراد محكوم جاهز
