...
**Stage:** 1 (not yet started outreach)
**Blocker:** First DM not sent
**Unblock:** Sami sends Abdullah Al-Assiri DM today
**Realistic first customer:** Day 7-14 (assuming warm lead converts)
**First paid revenue:** Day 14-21 (Pilot converts to Starter, assuming Moyasar KYC done OR manual bank transfer)
