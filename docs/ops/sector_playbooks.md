...
**ICP:** 20–500 employees, annual revenue >1M SAR, has Arabic-speaking market.

**Typical pain:** High lead volume post-funding or ad campaigns → slow SDR response → leads go cold → CAC inflates.
...
**ICP:** سلاسل مطاعم 5+ فروع، أو chains تتوسع.

**Typical pain:** Franchise inquiries + supplier leads تتراكم في email عام، أول من يرد يفوز — غالباً المنافس.
...
**ICP:** شركات تطوير، wasit digital platforms، brokerages الكبرى.

**Typical pain:** WhatsApp inquiries غير مفلترة → sales agent يضيع وقت على tire-kickers بدل buyers جديين.

**Proof angle:** 70% من real-estate leads ليسوا ready-to-buy — Dealix يفرز.
...
**ICP:** عيادات 3+ فروع، أو شبكات طبية متخصصة (أسنان، تجميل، خصوبة).

**Typical pain:** Booking inquiries بعد ساعات العمل يختفون — ما في من يرد من 10 م إلى 8 ص.
...
**ICP:** مدارس خاصة، مراكز تدريب مهني، academies أونلاين.

**Typical pain:** موسم التسجيل (يوليو-سبتمبر): آلاف الاستفسارات في أسبوعين، فريق التسجيل مُحاصر.
...
**ICP:** وكالات توظيف، HR consultancies، recruiting platforms.

**Typical pain:** جَمع CVs سهل، تأهيلهم للعميل شاق.

**Proof angle:** 80% من CVs في منصة توظيف ليست مطابقة للدور — recruiter يضيع وقت في فلترة.
...
**ICP:** شركات 3PL، شحن B2B، e-commerce fulfillment.

**Typical pain:** Quote requests B2B معقّدة — حجم، وزن، destination، تكرار — كل quote يحتاج sales engineer.

**Proof angle:** 40% من quote requests يموتون قبل ما يطلع quote.
...
## 8. E-commerce (B2B + B2C hybrid)

**ICP:** Salla/Zid merchants بـ 1K+ طلب/شهر، Shopify Saudi merchants.

**Typical pain:** WhatsApp سيل مستمر — "كم السعر؟"، "متى يوصل؟"، "هل عندكم أحمر؟" — fatigue.
...
## Cross-sector: "Agency clients"

لو العميل **وكالة** تبيع لعملائها:

**Offer:** setup fee 3,000-15,000 + 20-30% من MRR كل عميل وكالة تجيبه.
