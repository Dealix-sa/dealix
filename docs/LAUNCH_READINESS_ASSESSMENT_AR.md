...
- `/war-room` — غرفة حرب المؤسس الحيّة (KPIs الإيراد + أهم الأهداف + الطوابير + حدود العقيدة).
- `/approvals` — طابور موافقات حي + موافقة/رفض.
- `/evidence` — سجل الإثبات الحي.
- `/operator` — كوكبيت المشغّل (موحّد بصرياً).
- توحيد بصري + وسم «بيانات تجريبية» لصفحات `agents`/`safety`/`control-plane`.
- التنقّل: قسم «غرفة القيادة» ظاهر في الـNav وفي شريط الصفحة الرئيسية.

أسطح لاحقة عالية القيمة (مرشّحة، صفحات جديدة): السلسلة التجارية الكاملة، الـCockpit، التسويق/الحملات، الدعم، KB.
