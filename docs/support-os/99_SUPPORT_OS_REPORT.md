...
### Purpose / الغرض
- **EN:** Customer support operating system: channels, triage, incident response and feedback loops.
- **AR:** نظام دعم العملاء: القنوات والفرز والاستجابة للحوادث وحلقات التغذية الراجعة.

### Implementation summary / ملخص التنفيذ
- **What was implemented:** Support OS documentation set, generated and verified by `scripts/startup_os_verify.py`.
- **Files added:** 7 markdown documents under `docs/support-os/`.
