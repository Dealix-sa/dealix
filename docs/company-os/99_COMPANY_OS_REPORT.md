...
### Purpose / الغرض
- **EN:** The company-level operating system: strategy, market thesis, operating models, cadence, risks and roadmap.
- **AR:** نظام التشغيل على مستوى الشركة: الاستراتيجية وأطروحة السوق ونماذج التشغيل والإيقاع والمخاطر وخارطة الطريق.

### Implementation summary / ملخص التنفيذ
- **What was implemented:** Company OS documentation set, generated and verified by `scripts/startup_os_verify.py`.
- **Files added:** 14 markdown documents under `docs/company-os/`.
