# Demo OS — Report / Demo OS — تقرير

> **Purpose (EN):** Status report for Demo OS.
>
> **الغرض (AR):** تقرير حالة لـ Demo OS.
...
- Run `python scripts/demo_os_verify.py` for the machine-readable result.
