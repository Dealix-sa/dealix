# Hiring / People OS — People Os Report
## نظام التوظيف والأفراد
...
### Purpose / الغرض
- **EN:** Hiring and people operating system: first hires, role scorecards, interview and onboarding.
- **AR:** نظام التوظيف والأفراد: أول التعيينات وبطاقات تقييم الأدوار والمقابلات والإعداد.

### Implementation summary / ملخص التنفيذ
- **What was implemented:** Hiring / People OS documentation set, generated and verified by `scripts/startup_os_verify.py`.
- **Files added:** 8 markdown documents under `docs/people-os/`.
