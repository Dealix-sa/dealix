...
> **Purpose (EN):** Who to hire first.
>
> **الغرض (AR):** خطة أول التعيينات.


## Roles

- Founder assistant/ops, full-stack engineer, growth operator, delivery consultant, designer/content editor, compliance advisor (contractor), SDR (contractor).
