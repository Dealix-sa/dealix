...
- Govern: policies, roles, oversight apply across every other function.
- Map: inventory each agent, its purpose, and its risk surface.
- Measure: evals, trust flags, hallucination signals, incident counts.
- Manage: response, rollback, prompt update, scope reduction.
