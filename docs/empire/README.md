...
|--------|-------------|-------------|
| **A — Agency wedge** | [AGENCY_WEDGE.md](AGENCY_WEDGE.md) · [PROOF_PACK_STANDARD.md](PROOF_PACK_STANDARD.md) | [DEALIX_SALES_GTM_SOVEREIGN_MASTER_AR.md](../commercial/DEALIX_SALES_GTM_SOVEREIGN_MASTER_AR.md) §3 |
...
| طبقة | ملف |
|------|-----|
| Category | [DEALIX_CATEGORY.md](DEALIX_CATEGORY.md) |
| Method + SOAEN | [DEALIX_METHOD.md](DEALIX_METHOD.md) · [SOAEN_STANDARD.md](SOAEN_STANDARD.md) |
| Trust + Proof | [TRUST_LAYER.md](TRUST_LAYER.md) · [PROOF_PACK_STANDARD.md](PROOF_PACK_STANDARD.md) |
| Scale + Capital | [CAPITAL_MODEL.md](CAPITAL_MODEL.md) · [UNIT_ECONOMICS.md](UNIT_ECONOMICS.md) |
| Gates | [COMMERCIAL_GATES.md](COMMERCIAL_GATES.md) · [HIRING_GATES.md](HIRING_GATES.md) |
