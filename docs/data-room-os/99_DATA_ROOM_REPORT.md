# Data Room OS — Report / Data Room OS — تقرير

> **Purpose (EN):** Status report for Data Room OS.
>
> **الغرض (AR):** تقرير حالة لـ Data Room OS.
...
- Run `python scripts/data_room_verify.py` for the machine-readable result.
