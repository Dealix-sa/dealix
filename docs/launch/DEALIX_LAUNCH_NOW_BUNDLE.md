...
### B) Pay 1 SAR (اختبار دفع داخلي فقط — ليس عرضاً للعملاء)

> "1 ريال" هنا اختبار end-to-end للتحقق من مسار الدفع. العرض المعلَن
> للعملاء: تشخيص مجاني ثم سبرنت إثبات إيراد 7 أيام بـ 499 ريال.

1. افتح `payment_url` في المتصفح
2. ادفع ببطاقتك الحقيقية (Visa/Mada — 1 ريال فقط، اختبار داخلي)
...
عمليات إيراد و AI مُحوكَمة بالعربي الخليجي: يرتّب الفرص ويصيغ
مسودات تأهيل، وفريقك يعتمد كل رسالة قبل الإرسال.
نبدأ بتشخيص مجاني. voxc2.github.io/dealix
تستحق 20 دقيقة؟
```
...
Lucidya تقود سوق CXM في المنطقة، وفريق BDR عندكم يستحق عملية
إيراد منظّمة وموثّقة بالأدلة.

نبدأ بتشخيص مجاني، وبعده — إن ناسبك — سبرنت إثبات إيراد 7 أيام بـ 499 ريال.

تستحق 20 دقيقة الأسبوع؟
...
```
أستاذ عبدالله،
نمط متكرر في B2B السعودي: الفرص تبرد قبل أي قرار، لأن الترتيب
والتأهيل والمتابعة تتم بلا نظام ولا توثيق.
Dealix يعالج هذا تحديداً — عملية إيراد مُحوكَمة، وفريقك يعتمد كل خطوة.
نبدأ بتشخيص مجاني: voxc2.github.io/dealix
سامي
```
