...
MOYASAR_SECRET_KEY=<MOYASAR_LIVE_SECRET_PLACEHOLDER>
...
3. **Railway → Variables → RAW Editor:**
   - بدّل `MOYASAR_SECRET_KEY=<MOYASAR_LIVE_SECRET_PLACEHOLDER>`
   - بالـ secret الحقيقي `<MOYASAR_LIVE_SECRET_PLACEHOLDER>`
