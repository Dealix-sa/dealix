...
> **Purpose (EN):** Media index.
>
> **الغرض (AR):** فهرس الإعلام.


## Scope

- Brand voice, pillars, calendar, per-platform OS, ads readiness, PR.


## Forbidden

- auto-post, platform API posting, secrets, live paid ads.
