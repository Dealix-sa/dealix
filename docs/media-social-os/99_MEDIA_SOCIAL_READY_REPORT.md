# Media & Social OS — Media Social Ready Report
## نظام الإعلام والسوشيال
...
### Purpose / الغرض
- **EN:** Media and social operating system: brand voice, content pillars, 30-day calendar and per-platform playbooks.
- **AR:** نظام تشغيل الإعلام والسوشيال: صوت العلامة وركائز المحتوى وتقويم ٣٠ يوماً وأدلة كل منصة.

### Implementation summary / ملخص التنفيذ
- **What was implemented:** Media & Social OS documentation set, generated and verified by `scripts/startup_os_verify.py`.
- **Files added:** 17 markdown documents under `docs/media-social-os/`.
