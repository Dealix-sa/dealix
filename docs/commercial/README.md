...
| [**../ops/FOUNDER_OPERATING_SYSTEM_AR.md**](../ops/FOUNDER_OPERATING_SYSTEM_AR.md) | **نظام تشغيل المؤسس:** أمر صباحي واحد · `/ops` hub · targeting rotation · content → approval |
| [**DEALIX_UNIFIED_REVENUE_ATLAS_AR.md**](DEALIX_UNIFIED_REVENUE_ATLAS_AR.md) | **1 — فهرس علوي:** قمع، قنوات، SoT تسعير، فهرس مجلدات |
| [**DEALIX_SALES_GTM_SOVEREIGN_MASTER_AR.md**](DEALIX_SALES_GTM_SOVEREIGN_MASTER_AR.md) | **2 — عمق استراتيجي/تكتيكي:** سوشال، استهداف، Motions، حاكمية أتمتة |
| [**../ops/FOUNDER_REVENUE_DAY_ONE_AR.md**](../ops/FOUNDER_REVENUE_DAY_ONE_AR.md) | **3 — يوم واحد:** صباح–مساء–جمعة · `scripts/run_founder_commercial_day.sh` |
| [operations/FOUNDER_GTM_BENCHMARKS_AR.md](operations/FOUNDER_GTM_BENCHMARKS_AR.md) | مقارنة GTM خارجية vs Dealix |
