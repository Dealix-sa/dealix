...
**خدمات:** Free AI Ops Diagnostic، 7-Day Revenue Proof Sprint، Data-to-Revenue Pack، Managed Revenue Ops — كما في [DEALIX_REVOPS_PACKAGES_AR.md](DEALIX_REVOPS_PACKAGES_AR.md).
...
## كتالوج خدمات مختصر — سلم العروض المعتمد (ريال سعودي)

> **مصدر التسعير الرسمي:** [`docs/OFFER_LADDER_AND_PRICING.md`](../OFFER_LADDER_AND_PRICING.md)
> والتفصيل التجاري في [`DEALIX_REVOPS_PACKAGES_AR.md`](DEALIX_REVOPS_PACKAGES_AR.md).
> أي تسميات/نطاقات أسعار قديمة (Revenue Diagnostic، Lead Intelligence Sprint
> 9,500–18,000، Pilot Conversion، AI Support Desk، Quick Win، إلخ) **مُلغاة**.

| الدرجة | الخدمة | السعر المعتمد |
|--------|--------|----------------|
| 0 | Free AI Ops Diagnostic | مجاني |
| 1 | 7-Day Revenue Proof Sprint | 499 (دفعة واحدة) |
| 2 | Data-to-Revenue Pack | 1,500 (مشروع واحد) |
| 3 | Managed Revenue Ops | 2,999–4,999/شهر |
| 4 | Executive Command Center | 7,500–15,000/شهر |
| 5 | Agency Partner OS | مخصص + rev-share 15–30% |

العمل التنفيذي المخصّص الأكبر (تكاملات ERP، حوكمة بيانات مؤسسية، SLA مخصّص)
يُعرّف ضمن Rung 5 أو SOW منفصل ولا يُعلن سعراً ثابتاً على الموقع العام.
