# Documentation Governance OS — Report / Documentation Governance OS — تقرير

> **Purpose (EN):** Status report for Documentation Governance OS.
>
> **الغرض (AR):** تقرير حالة لـ Documentation Governance OS.
...
- Run `python scripts/docs_governance_verify.py` for the machine-readable result.
