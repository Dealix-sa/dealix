...
# Moyasar Payments
MOYASAR_SECRET_KEY=<paste-from-dashboard>
MOYASAR_WEBHOOK_SECRET=<paste-from-dashboard>

# PostHog Analytics (اختياري لكن موصى به)
POSTHOG_API_KEY=<paste-from-dashboard>
POSTHOG_HOST=https://us.i.posthog.com

# Calendly
CALENDLY_URL=https://calendly.com/sami-assiri11/dealix-demo
CALENDLY_WEBHOOK_SECRET=<paste-from-dashboard>
...
في Railway أو Render: أضف `landing/` كـ static serving. أو استخدم nginx reverse proxy.
...
**الحل:** التطبيق يحوّل `postgres://` → `postgresql+asyncpg://` تلقائياً.
...
- `MOYASAR_SECRET_KEY` للإنتاج فقط
...
- Owner: راجع `AGENTS.md` لقائمة الجهات المسؤولة
