...
> **Purpose (EN):** Email deliverability.
>
> **الغرض (AR):** جاهزية البريد.


## Setup

- SPF/DKIM/DMARC records, Postmaster monitoring, warm-up plan.


## Rule

- Configuration guidance only — no automated sending added.
