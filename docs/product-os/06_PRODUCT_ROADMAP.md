...
> **Purpose (EN):** MVP and later.
>
> **الغرض (AR):** خارطة المنتج.


## MVP

- Draft Factory + Review Queue + Site + Analytics schema.


## Later

- Service Engine depth, expansion automation (still review-gated).
