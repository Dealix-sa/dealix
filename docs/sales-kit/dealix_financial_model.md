...
> **مُعلَّم للمراجعة (المؤسّس + المالية):** حُدِّث **هيكل الأسعار** ليطابق السلّم المعتمد (Free Mini Diagnostic 0 ← Revenue Proof Sprint 499 ← Data-to-Revenue Pack 1,500 ← Growth Ops Monthly 2,999/شهر ← Support OS Add-on 1,500/شهر ← Executive Command Center 7,500/شهر ← Agency Partner OS مخصّص). أما **جداول التوقّعات الشهرية وقيمة ARPA (2,449)** المبنية على الباقات القديمة (Starter 999 / Growth 2,999 / Scale 7,999) فلم تُعَد اشتقاقها تلقائياً تفادياً لإدخال أرقام متضاربة في نموذج مترابط — **بنود مُعلَّمة لإعادة بناء النموذج المالي يدوياً** على السلّم الجديد. كل الأرقام تقديرية.
...
| الباقة | السعر | النوع | الهدف الشهري | الملاحظات |
|--------|-------|-------|---------------|-----------|
| Free Mini Diagnostic | 0 | مرة واحدة | مدخل القمع | تشخيص مجاني |
| Revenue Proof Sprint | 499 | مرة واحدة | عرض الدخول | يثبت القيمة بأدلة |
| Data-to-Revenue Pack | 1,500 | مرة واحدة | إضافة | حزمة بيانات إلى إيراد |
| Growth Ops Monthly | 2,999/شهر | اشتراك | الإيراد المتكرّر الأساسي | ~60% من العملاء النشطين |
| Support OS Add-on | 1,500/شهر | اشتراك | إضافة | ~25% من العملاء النشطين |
| Executive Command Center | 7,500/شهر | اشتراك | الشريحة العليا | ~15% من العملاء النشطين |
| Agency Partner OS | مخصّص + حصة إيرادات 15–30% | شراكة | قناة الوكالات | — |

**Weighted Average Recurring Revenue Per Account (ARPA) — تقديري:** يُحتسب على الاشتراكات المتكرّرة (Growth Ops Monthly، Support OS Add-on، Executive Command Center) حسب التوزيع أعلاه. الأرقام تقديرية وتُراجَع مع نمو القاعدة الفعلية.
