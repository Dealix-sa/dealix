...
> العميل يتوقع يقرأ مسودة باللهجة الخليجية، ليس ترجمة. Dealix مبني 
> لهذا بالضبط: رادار عمليات محكوم يكتب الرسالة التالية المقترحة 
> ويضعها في طابور موافقتك. الأسعار في خريطة الربط التجاري."

### السيناريو المنتصر:
- العميل قيّم Drift وبدأ تطبيق
- استغرق 8 أسابيع setup
- عملاؤه عربي وفشل الـ AI
- Dealix: يبدأ بـ Revenue Proof Sprint — مخرج 7 أيام، اللهجة مضبوطة
...
### رد مُحكم:
> "Intercom أداة رائعة للـ customer support. لكن Dealix رادار 
> عمليات للمبيعات — هدفه مختلف. Intercom يجيب أسئلة؛ Dealix 
> يعرض حالة كل lead ويكتب الرسالة التالية المقترحة في طابور موافقتك."
...
- لا يعرض حالة كل lead على رادار موحّد
- لا مسودات مرتبطة بسلسلة أدلة
...
- لا رؤية لحالة كل lead بعد وصوله
- Dealix: رادار موحّد + مسودات جاهزة للموافقة + سلسلة أدلة
- "ابدأ بـ Revenue Proof Sprint — مخرج 7 أيام يثبت الفرق على leads الفعلية."
...
- لا رادار حالة ولا طابور موافقة
- لا سلسلة أدلة قابلة للمراجعة
- المُطوّر يحتاج يصير متخصص AI

### رد مُحكم:
> "عندك خيارين: (1) تبني رادار عمليات محكوم من صفر — يأخذ 6 شهور، 
> فريق 3 مطورين، تكلفة عالية. (2) تبدأ بـ Dealix — جاهز اليوم 
> عبر Revenue Proof Sprint. السؤال: هل تبي تبني أداة أو تبي تبيع؟"
...
- لا رادار حالة، لا مسودات بموافقة، لا سلسلة أدلة
...
> volume leads (100+/أسبوع)، يصعب على agency تتبّع حالة كل lead. 
> Dealix رادار يعرض حالة كل lead ويكتب مسودة الرسالة التالية 
> للموافقة. الاثنين مكملان — agency للحسابات الكبرى، Dealix يعطي 
> فريقك صورة موحّدة عن البقية."
...
### رد مُحكم:
> "WhatsApp Business = قناة. Dealix = رادار العمليات الذي يقرأ 
> القناة. الاثنان معاً: Dealix يسجّل وصول lead من WhatsApp، يعرض 
> حالته، ويكتب مسودة الرسالة التالية لموافقتك قبل أي إرسال."
...
- ✅ مستعدّة تبدأ بـ Revenue Proof Sprint (مخرج 7 أيام)
...
2. **Speed** — Revenue Proof Sprint يعطي مخرج خلال 7 أيام
3. **Governance** — مسودات فقط، موافقة قبل أي إرسال، سلسلة أدلة قابلة للمراجعة
...
> "أفهم إن [المنافس] مثير للاهتمام. اقتراح: ابدأ بـ Revenue 
> Proof Sprint — مخرج 7 أيام على leads شركتك الفعلية: تشخيص، 
> مسودات جاهزة للموافقة، وProof Pack. القرار بعد الدليل، لا قبله."

**هذا العرض يقلّل المخاطرة لأن العميل يرى مخرجاً ملموساً قبل أي توسّع.**
...
> الأسعار وSKU كل عرض في `docs/COMMERCIAL_WIRING_MAP.md`. السردية
> الرسمية في `NARRATIVE_VCURRENT.md`.
