...
### 9. "شو الـ pricing strategy؟"
**الرد**: سلم مُثبَت بالنتائج (Proof-gated ladder)، لا باقات SaaS مفتوحة. نقطة الدخول منخفضة المخاطرة عمداً: تشخيص AI Ops مجاني (Tier 0)، ثم **Revenue Intelligence Sprint بـ 499 ر.س لمدة 7 أيام** (Tier 1) — هدفه إثبات النتيجة قبل أي التزام شهري. كل درجة أعلى (Data-to-Revenue Pack 1,500 ر.س، ثم Managed Revenue Ops 2,999–4,999 ر.س/شهر) تُفتح فقط بعد إثبات موثّق من الدرجة السابقة. هذا التصميم يخفض CAC ويرفع الثقة. مصدر الأسعار الوحيد: `docs/OFFER_LADDER_AND_PRICING.md`.
