...
Dealix يستقبل lead ويجهّز مسودة ردّ عربية بانتظار اعتماد الفريق

"Dealix يجهّز ردّاً مسوّداً جاهزاً بالعربية على كل lead، تراجعه وتعتمده قبل الإرسال."
"يجهّز أسئلة التأهيل كمسودة."
"يجهّز مسودة متابعة ودعوة اجتماع ترسلها بنفسك."

[الثانية 30-40] النتائج على الشاشة (قيم تقديرية، نمط آمن للحالات):
✓ معدل تأهيل أعلى مع مسودات جاهزة
✓ ساعات BDR موفّرة أسبوعياً
✓ متابعة أسرع وأدق — والقرار يبقى لك

"نتائج أول عميل: [قيم تقديرية، ليست وعداً]"
...
"عندما يدخل lead في الصباح، قد يأخذ الرد 4 ساعات.
...
"لكن ماذا لو..."
"كل lead عندك مسودة ردّ عربية جاهزة تراجعها وتعتمدها قبل الإرسال؟"
"كل محادثة تبدأ بسؤال ذكي بالعربي الخليجي؟"
"كل lead مفروز ومعه مسودة دعوة اجتماع — قبل ما تفتح جوالك؟"
...
[عرض المحادثة:]
- Lead يدخل
- Dealix يجهّز مسودة ردّ بالعربي
- يجهّز 8 أسئلة تأهيل كمسودة للمراجعة
- يقترح تصنيف الـ lead (A/B/C/D)
- يجهّز مسودة دعوة اجتماع ترسلها بنفسك
...
خلال 48 ساعة من الاشتراك، Dealix يبدأ يجهّز لك المسودات."

"عملاؤنا الأوائل يرون (قيم تقديرية، نمط آمن للحالات):
- معدل تأهيل أعلى مع مسودات جاهزة
- ساعات موفّرة لكل BDR
- متابعة أسرع وأدق — والقرار يبقى للإنسان"
...
- Screen recording: Lead entry → AI draft → human review & approve → manual send
- Explain: Why Arabic-khaliji native matters
- Show: BANT questions prepared as a draft for review
- Integration points
- Make the governance explicit: Dealix drafts, the human approves, then it is sent — no external auto-send
...
5. **Bold claim:** "Dealix = طبقة تجهيز عربية محوكمة بـ 999 ريال/شهر — مسودات جاهزة، أنت تعتمد."
