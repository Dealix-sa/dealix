...
████████████████████████████████
        Dealix
  رادار عمليات إيراد عربي محوكم — مسودات وموافقة
████████████████████████████████
...
```
Dealix = رادار عمليات إيراد عربي محوكم — مسودات وموافقة، لا إرسال تلقائي
...
✅ خدمة عمليات إيراد بقيادة المؤسس: الذكاء الاصطناعي يجهّز، أنت تعتمد، ثم يُرسَل

= فريقك يبدأ يومه بمسودات جاهزة وleads مفروزة، لا reactive firefighting
```

**Visual:** screenshot من Dealix في action — مسودة ردّ بالعربي بانتظار اعتماد المؤسس.
...
1️⃣ LEAD INGEST
   ...
   ↓
2️⃣ AI DRAFT
   Dealix يجهّز 8 أسئلة BANT كمسودة
   ردّ بلهجة خليجية طبيعية — مسوّد للمراجعة
   ↓  
3️⃣ REVIEW & APPROVE → DELIVER
   المؤسس/الفريق يراجع المسودة ويعتمدها
   مسودة دعوة اجتماع + ملخّص 1-صفحة جاهزان للإرسال اليدوي
   تحديث CRM بعد الاعتماد — لا إرسال خارجي تلقائي
```
...
2. مسودة ردّ عربية طبيعية بانتظار الاعتماد
3. Qualification summary
4. Dashboard اعتماد المسودات للعميل

النقطة الرئيسية:
"لأول مرة، شركة سعودية تجهّز ردوداً عربية حقيقية
لعملاء سعوديين — والقرار النهائي يبقى للإنسان."
```
...
BANT draft prep    |  ✅    |       ⚠️       |       ❌        |      ✅
Meeting-invite draft| ✅    |       ⚠️       |       ❌        |      ✅
Human-approved send|  ✅    |       ❌       |       ❌        |      ✅
Cost per lead      | 2 ريال | 8 ريال         |  5 ريال         |  45 ريال
Scalability        |  ✅✅  |       ✅       |       ⚠️        |      ❌

Positioning: "طبقة تجهيز عربية محوكمة — سرعة الأداة مع رقابة الإنسان."
```
