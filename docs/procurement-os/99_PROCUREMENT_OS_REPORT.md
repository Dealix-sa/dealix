# Procurement OS — Report / Procurement OS — تقرير

> **Purpose (EN):** Status report for Procurement OS.
>
> **الغرض (AR):** تقرير حالة لـ Procurement OS.
...
- Run `python scripts/procurement_verify.py` for the machine-readable result.
