...
### Purpose / الغرض
- **EN:** The founder-led sales motion: process, pipeline, discovery, qualification, proposals and closing.
- **AR:** حركة المبيعات بقيادة المؤسس: العملية وخط الأنابيب والاكتشاف والتأهيل والعروض والإغلاق.

### Implementation summary / ملخص التنفيذ
- **What was implemented:** Sales OS documentation set, generated and verified by `scripts/startup_os_verify.py`.
- **Files added:** 12 markdown documents under `docs/sales-os/`.
