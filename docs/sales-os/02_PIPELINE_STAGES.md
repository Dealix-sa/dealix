...
> **Purpose (EN):** Canonical stages.
>
> **الغرض (AR):** مراحل خط الأنابيب.


## Stages

- raw lead, researched, draft generated, founder review, manually contacted, replied positive, discovery booked, diagnostic proposed, diagnostic sold, pilot proposed, pilot sold, retainer, expansion, disqualified, suppressed.
...
- **GO/NO-GO:** GO (internal asset) — external actions remain founder-gated
