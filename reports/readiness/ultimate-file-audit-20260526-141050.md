...
Generated: 2026-05-26 14:10:50

- Present: 50/70
- Weighted readiness score: 77.27%
...
| 04_revenue_payment | `data/ledgers/revenue_ledger.json` | False | 4 |
...
| 05_delivery_proof_retainer | `data/ledgers/delivery_ledger.json` | False | 4 |
...
| 07_hermes_partner_productization | `scripts/hermes_partner_os.py` | False | 3 |
| 07_hermes_partner_productization | `scripts/hermes_partner_pack.py` | False | 3 |
| 07_hermes_partner_productization | `scripts/hermes_case_study.py` | False | 3 |
| 07_hermes_partner_productization | `scripts/hermes_productization_gate.py` | False | 3 |
| 07_hermes_partner_productization | `scripts/hermes-partner-product-run.ps1` | False | 3 |
| 07_hermes_partner_productization | `docs/partners/HERMES_PARTNER_OS_AR.md` | False | 3 |
| 07_hermes_partner_productization | `docs/productization/HERMES_PRODUCTIZATION_RULES_AR.md` | False | 3 |
| 08_key_ledgers | `data/ledgers/hermes_signals.json` | False | 4 |
| 08_key_ledgers | `data/ledgers/hermes_opportunities.json` | False | 4 |
| 08_key_ledgers | `data/ledgers/hermes_outcomes.json` | False | 4 |
| 08_key_ledgers | `data/ledgers/hermes_assets.json` | False | 4 |
| 08_key_ledgers | `data/ledgers/hermes_deal_rooms.json` | False | 4 |
| 08_key_ledgers | `data/ledgers/hermes_partners.json` | False | 4 |
| 08_key_ledgers | `data/ledgers/hermes_productization.json` | False | 4 |
...
| 09_manuals | `docs/partners/HERMES_PARTNER_OS_AR.md` | False | 2 |
| 09_manuals | `docs/productization/HERMES_PRODUCTIZATION_RULES_AR.md` | False | 2 |
