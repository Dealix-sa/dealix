# Sector Page Brief — خدمات IT (`/ar/industries/it-services`)
...
1. **Pain headline** — اكتب الألم المحدد لقطاع خدمات IT: delivery + support + client memory.
...
- [ ] `<title>` + meta description موجهة لقطاع خدمات IT
- [ ] canonical URL مضبوط
