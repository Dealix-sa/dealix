# Sector Page Brief — التوظيف (`/ar/industries/recruitment`)
...
1. **Pain headline** — اكتب الألم المحدد لقطاع التوظيف: pipeline + follow-up + operations.
...
- [ ] `<title>` + meta description موجهة لقطاع التوظيف
- [ ] canonical URL مضبوط
