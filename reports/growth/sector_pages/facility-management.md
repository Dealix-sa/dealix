# Sector Page Brief — التشغيل وإدارة المرافق (`/ar/industries/facility-management`)
...
1. **Pain headline** — اكتب الألم المحدد لقطاع التشغيل وإدارة المرافق: SLA + delivery visibility.
...
- [ ] `<title>` + meta description موجهة لقطاع التشغيل وإدارة المرافق
- [ ] canonical URL مضبوط
