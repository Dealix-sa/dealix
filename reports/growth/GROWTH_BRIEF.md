...
Generated: 2026-06-05T17:54:06.842357+00:00

## Asset inventory

- Free tools (lead magnets): **6**
- Content ideas in pool: **20** (2 need founder approval)
- Growth experiments: **10**
- Nurture sequences: **2**
- Partner categories: **9**
...
- [ ] Content `C-006`: case-safe: المشكلة لم تكن نقص leads بل غياب next action واضح
- [ ] Content `C-020`: case-safe: من فوضى المتابعة إلى Next Action Board واضح
