...
def _tenant_scope(user: Any, declared_tenant_id: str | None = None) -> str:
    ...
    named in the body is a request, never authorisation.
    """
    try:
...
async def update_deal(
    ...
    """
    tenant_id = _tenant_scope(user, body.get("tenant_id"))
    async with async_session_factory()() as session:
