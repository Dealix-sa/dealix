...
async def program_terms() -> dict[str, Any]:
    ...
    return {
        ...
        "referrer_reward": {
            ...
            "applied_when": "referred customer pays first invoice ≥ 499 SAR",
...
async def redeem_referral(body: _RedeemRequest) -> dict[str, Any]:
    ...
    return {
        ...
        "max_discount_sar_revenue_proof_sprint": 499 * REFERRED_DISCOUNT_PCT // 100,
        "max_discount_sar_growth_ops": 2999 * REFERRED_DISCOUNT_PCT // 100,
        "max_discount_sar_executive_command_center": 7500 * REFERRED_DISCOUNT_PCT // 100,
