...
async def demo() -> dict[str, Any]:
    """Synthetic research hypotheses for UI preview; never real prospects."""
    return {
        ...
        "use_case": "sales",
        "icp": "مثال افتراضي لقطاع SaaS B2B — ليس طلب بحث حقيقي",
        "count_requested": 3,
        "count_returned": 3,
        "search_notes": (
            "أمثلة اصطناعية فقط لتوضيح شكل المخرجات. لا تمثل شركات أو أشخاصًا حقيقيين، "
            "ولا يجوز استخدامها للتواصل قبل إضافة مصدر عام والتحقق البشري."
        ),
        "leads": [
            {
                "company_ar": "شركة افتراضية ألف",
                "company_en": "Synthetic SaaS Alpha",
                "industry": "SaaS B2B — مثال اصطناعي",
                "est_size": "غير متحقق",
                "website": None,
                "linkedin": None,
                "decision_maker_hints": [],
                "signals": ["فرضية بحث: توسع معلن — يحتاج مصدرًا عامًا"],
                "outreach_opening": "مسودة محجوبة حتى توثيق الإشارة والتحقق البشري.",
                "fit_score": 0,
                "confidence": 0,
                "evidence": "لا يوجد دليل في وضع العرض الاصطناعي.",
                "risk_level": "BLOCKED",
                "recommended_channel": "HOLD_FOR_APPROVAL",
                "next_action": "RESEARCH_MORE",
            },
            {
                "company_ar": "شركة افتراضية باء",
                "company_en": "Synthetic Services Beta",
                "industry": "خدمات B2B — مثال اصطناعي",
                "est_size": "غير متحقق",
                "website": None,
                "linkedin": None,
                "decision_maker_hints": [],
                "signals": ["فرضية بحث: توظيف فريق مبيعات — يحتاج مصدرًا عامًا"],
                "outreach_opening": "مسودة محجوبة حتى توثيق الإشارة والتحقق البشري.",
                "fit_score": 0,
                "confidence": 0,
                "evidence": "لا يوجد دليل في وضع العرض الاصطناعي.",
            ...
            {
                "company_ar": "شركة افتراضية جيم",
                "company_en": "Synthetic Commerce Gamma",
                "industry": "تجارة إلكترونية — مثال اصطناعي",
                "est_size": "غير متحقق",
                "website": None,
                "linkedin": None,
                "decision_maker_hints": [],
                "signals": ["فرضية بحث: إطلاق منتج جديد — يحتاج مصدرًا عامًا"],
                "outreach_opening": "مسودة محجوبة حتى توثيق الإشارة والتحقق البشري.",
                "fit_score": 0,
                "confidence": 0,
                "evidence": "لا يوجد دليل في وضع العرض الاصطناعي.",
