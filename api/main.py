...
# Founder Console v1 — internal read-only API at /api/v1/internal/founder/*
from api.routers.internal import founder as internal_founder_router
...
def create_app() -> FastAPI:
    ...
    # Founder Console v1 — internal read-only API (super_admin only)
    app.include_router(internal_founder_router.router)
