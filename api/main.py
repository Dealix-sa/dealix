...
# Wave 15 — Unified AI Stack (L1..L11 orchestrator)
from api.routers import ai_stack as ai_stack_router
...
def create_app() -> FastAPI:
    ...
    # Wave 15 — Unified AI Stack (L1..L11 orchestrator + /ar/ai-stack UI backend)
