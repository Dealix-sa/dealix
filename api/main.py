...
from api.routers.internal import founder_console as internal_founder_console_router
...
def create_app() -> FastAPI:
    ...
    # Founder Console v2 — internal API surface (self-prefixed /api/v1/internal)
    app.include_router(internal_founder_console_router.router)
