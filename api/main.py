...
def create_app() -> FastAPI:
    ...
    async def root() -> dict[str, object]:
        return {
            ...
            "governed_revenue_ops_catalog": "/api/v1/revenue-ops/catalog",
            "governed_revenue_ops_diagnostic": "/api/v1/revenue-ops/diagnostics",
            "governed_evidence_events": "/api/v1/evidence/events",
            "governed_invoice_draft": "/api/v1/invoices",
