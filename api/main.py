...
from api.routers.internal import founder_console as founder_console_v4_router
...
def create_app() -> FastAPI:
    ...
    # Founder Console v4 — /api/v1/internal/{ceo,sales,approvals,finance,...}
    app.include_router(founder_console_v4_router.router)
