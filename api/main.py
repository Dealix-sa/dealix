...
# Market Attack & Scaling Layer (v12)
from api.routers import market_attack_internal as market_attack_internal_router
...
def create_app() -> FastAPI:
    ...
    # Market Attack & Scaling internal endpoints (admin-gated)
    app.include_router(market_attack_internal_router.router)
