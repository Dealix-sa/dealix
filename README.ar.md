...
## 🏗️ نظام إطلاق الأعمال (Business OS Launch System)

الإطار الأكبر: **Dealix شركة نظام تشغيل أعمال بالذكاء الاصطناعي** للشركات السعودية والخليجية — تبدأ من الإيرادات والقرار والإثبات، ثم تتوسع إلى العملاء، التسليم، الدعم، المالية، البيانات، الحوكمة، الشراكات، والتدريب. محرك الاستهداف مجرد نظام واحد من **14 نظام تشغيل**.

أول وتد تجاري: **Command Sprint** (٧ أيام) — نوسّع الرؤية، نضيّق العرض الأول، نكسب عميلًا، نسلّم Proof، نحوّله لاشتراك، ثم نوسّع داخل العميل.

| الطبقة | الوثيقة |
|---|---|
| حقيقة المنصة — مصدر الحقيقة، المعمار، سلّم المنتجات، حالة الوحدات، برج التحكم | [`docs/00_platform_truth/`](docs/00_platform_truth/PLATFORM_SOURCE_OF_TRUTH.md) |
| الذهاب للسوق — عرض Command Sprint، الذكاء السوقي، الاستهداف، دليل المبيعات، التسعير، الشركاء | [`docs/01_go_to_market/`](docs/01_go_to_market/COMMAND_SPRINT_OFFER.md) |
| أنظمة التشغيل — مواصفات الأنظمة الـ14 (Command → Academy) | [`docs/02_operating_systems/`](docs/02_operating_systems/COMMAND_OS.md) |
| الحوكمة — سياسة الموافقة، سجل الادعاءات، منع السبام، الاحتفاظ، جاهزية PDPL، الأفعال الخارجية | [`docs/03_governance/`](docs/03_governance/HUMAN_APPROVAL_POLICY.md) |
| التسليم — دليل Sprint السبعة أيام، مجلد العميل، Proof Pack، معايير القبول | [`docs/04_delivery/`](docs/04_delivery/COMMAND_SPRINT_DELIVERY_OS.md) |
| المؤسس — القيادة اليومية، مراجعة المجلس الأسبوعية، بطاقة أداء CEO، بوابة الإطلاق | [`docs/05_founder/`](docs/05_founder/FOUNDER_DAILY_COMMAND.md) |

**قواعد صارمة لا تُكسر:** لا إرسال تلقائي · لا واتساب جماعي · لا scraping خلف تسجيل دخول · لا proof مزيّف · لا ضمان إيرادات · لا نشر اسم عميل بدون إذن · لا استخدام بيانات العميل للتدريب · لا فعل خارجي بدون موافقة المؤسس · كل هدف يحتاج دليلًا · كل عميل مدفوع له مجلّد و Proof Pack.

حالة الإطلاق العام: **No-Go** حتى تتحقق ≥٣ Sprints مدفوعة + ٣ Proof Packs + Case Study واحدة + صفر حوادث ثقة — راجع [برج التحكم](docs/00_platform_truth/LAUNCH_CONTROL_TOWER.md).

> هذه أهداف تشغيلية وليست ضمانًا للنتائج.
