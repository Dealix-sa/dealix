...
## 🎯 الاستراتيجية (مصدر الحقيقة)

**ديلكس ليس أداة ذكاء اصطناعي؛ ديلكس آلة تشغيل إيراد سعودية: الذكاء يجهز، الأنظمة تنفذ، الثقة تحكم، والإنسان يوافق على القرارات الحساسة.** الاستراتيجية الكاملة (2026-05-22): [`docs/strategy/FULL_OPS_STRATEGY.md`](docs/strategy/FULL_OPS_STRATEGY.md) · خطة 30/60/90: [`docs/strategy/ROADMAP_30_60_90.md`](docs/strategy/ROADMAP_30_60_90.md) · توافق مع الوثائق السابقة: [`docs/strategy/RECONCILIATION.md`](docs/strategy/RECONCILIATION.md).
