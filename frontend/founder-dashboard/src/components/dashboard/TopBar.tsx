...
export default function TopBar(_props: Props) {
  ...
  void searchFocused; // intentionally tracked
  const now = new Date();
  ...
  return (
    <header className="h-16 bg-white border-b border-gray-100 flex items-center justify-between px-6 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Notifications */}
        <button className="relative p-2 text-gray-500 hover:text-dealix-emerald hover:bg-dealix-emerald/5 rounded-lg transition-colors">
