  ...
  return (
    <main dir="rtl" className="min-h-screen bg-[#070b12] text-white px-6 py-16">
      <section className="mx-auto max-w-5xl space-y-8">
        ...
        <h1 className="text-4xl font-bold">Dealix للعقار والخدمات عالية القيمة</h1>
        <p className="text-xl text-slate-300">كل فرصة عقارية تستحق متابعة دقيقة ومراحل واضحة.</p>
