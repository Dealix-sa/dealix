...
const METRIC_CARDS: MetricCard[] = [
  {
    ...
    labelAr: "وقت التشغيل",
    labelEn: "Uptime",
    descAr: "هدف توفّر الخدمة",
    descEn: "Service availability target",
    icon: "S",
  ...
  },
  {
    ...
    valueAr: "ربع سنوي",
    valueEn: "Quarterly",
    labelAr: "مراجعة أمنية مستقلة",
    labelEn: "Independent Security Review",
    descAr: "مُجدوَلة ضمن سياسة الأمن لدينا",
    descEn: "Scheduled per our security policy",
    icon: "A",
    color: "text-blue-400",
  },
  {
    ...
    valueAr: "72 ساعة",
    valueEn: "72h",
    labelAr: "إشعار خرق البيانات",
    labelEn: "Breach Notification",
    descAr: "ضمن سياسة الاستجابة للحوادث",
    descEn: "Per our incident-response policy",
    icon: "C",
    color: "text-emerald-500",
  },
];
