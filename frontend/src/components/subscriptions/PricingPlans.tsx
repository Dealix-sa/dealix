...
// Canonical ladder — mirrors auto_client_acquisition/service_catalog/registry.py
// (Free → 499 Sprint → 2,999–4,999/mo Managed Ops → 7,500–15,000/mo ECC).
// Bespoke "Custom Solution" requests route to /custom (no fixed price).
const PLANS: PricingPlan[] = [
  {
    ...
    periodAr: "ر.س",
    periodEn: "SAR",
    forAr: "أي مؤسس B2B سعودي",
    forEn: "Any Saudi B2B founder",
    highlight: false,
    colorScheme: "blue",
    ctaAr: "ابدأ مجاناً",
    ctaEn: "Start Free",
    ...
    features: [
      { textAr: "تحليل ملاءمة قطاعك (صفحة واحدة)", textEn: "1-page sector-fit analysis" },
      { textAr: "أفضل 3 فرص مرتبة", textEn: "3 ranked opportunities" },
      { textAr: "مسودة رسالة عربية واحدة", textEn: "1 Arabic message draft" },
      { textAr: "أفضل قناة تواصل + خطوة تالية", textEn: "Best channel + next step" },
      { textAr: "تسليم خلال 24 ساعة", textEn: "Delivered within 24 hours" },
    ],
  },
  {
    ...
    priceAr: "499",
    priceEn: "499",
    periodAr: "ر.س / لمرة واحدة",
    periodEn: "SAR / one-time",
    forAr: "من يريد إثباتاً سريعاً خلال أسبوع",
    forEn: "Founders wanting fast proof in a week",
    highlight: false,
    colorScheme: "blue",
    ctaAr: "ابدأ الآن",
    ctaEn: "Start Now",
    href: "/dealix-diagnostic",
    features: [
      { textAr: "7 مخرجات في 7 أيام", textEn: "7 deliverables in 7 days" },
      { textAr: "أفضل 10 فرص مرتبة", textEn: "Top 10 ranked opportunities" },
      { textAr: "5 مسودات رسائل عربية للاعتماد", textEn: "5 Arabic message drafts to approve" },
      { textAr: "Proof Pack + ملخص تنفيذي", textEn: "Proof Pack + executive summary" },
      { textAr: "خطة متابعة 7 أيام", textEn: "7-day follow-up plan" },
      { textAr: "استرداد كامل 100% خلال 14 يوماً", textEn: "Full 100% refund within 14 days" },
    ],
  },
  {
    id: "growth_ops_monthly_2999",
    nameAr: "عمليات النمو المُدارة",
    nameEn: "Managed Growth Ops",
    priceAr: "2,999 – 4,999",
    priceEn: "2,999 – 4,999",
    periodAr: "ر.س / شهر",
    periodEn: "SAR / mo",
    forAr: "بعد sprint ناجح — استمرارية شهرية",
    forEn: "After a successful sprint — monthly continuity",
    highlight: true,
    colorScheme: "gold",
    ...
    href: "/dealix-diagnostic",
    features: [
      { textAr: "تدقيق pipeline أسبوعي", textEn: "Weekly pipeline audit" },
      { textAr: "≥20 مسودة رسالة شهرياً (باعتماد)", textEn: "≥20 message drafts/mo (approved)" },
      { textAr: "Proof Pack شهري + ملخص تنفيذي", textEn: "Monthly Proof Pack + exec summary" },
      { textAr: "التزام: +20% معدل ردود خلال 4 أشهر", textEn: "Commitment: +20% reply-rate in 4 months" },
      { textAr: "جلسة استراتيجية شهرية 60 دقيقة", textEn: "Monthly 60-min strategy session" },
      { textAr: "تشغيل بقيادة المؤسس (شبه مؤتمت)", textEn: "Founder-led delivery (semi-automated)" },
    ],
  },
  {
    ...
    priceAr: "7,500 – 15,000",
    priceEn: "7,500 – 15,000",
    periodAr: "ر.س / شهر",
    periodEn: "SAR / mo",
    forAr: "المؤسس / الإدارة العليا",
    forEn: "Founder / C-suite",
    highlight: false,
    colorScheme: "navy",
    ctaAr: "تواصل معنا",
    ctaEn: "Contact Us",
    href: "/custom",
    features: [
      { textAr: "موجز تنفيذي يومي", textEn: "Daily executive brief" },
      { textAr: "رادار سوق أسبوعي", textEn: "Weekly market radar" },
      { textAr: "حزمة مجلس شهرية كاملة", textEn: "Full monthly board pack" },
      { textAr: "استراتيجية نمو ربع سنوية", textEn: "Quarterly growth strategy" },
      { textAr: "يُفتح بعد 3 sprints + case study", textEn: "Unlocks after 3 sprints + case study" },
      { textAr: "تشغيل بقيادة المؤسس (شبه مؤتمت)", textEn: "Founder-led delivery (semi-automated)" },
    ],
  },
];
