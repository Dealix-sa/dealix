...
const PRICING = [
  ...
  },
  {
    ...
    periodAr: "",
    periodEn: "",
    featuresAr: ["كل ميزات النمو", "تكامل API مخصص", "مدير حساب مخصص", "SLA ملتزم به", "تدريب الفريق", "audit log كامل"],
    featuresEn: ["Everything in Growth", "Custom API integration", "Dedicated account manager", "SLA commitment", "Team training", "Full audit log"],
    popular: false,
