...
const navItems: NavItem[] = [
  ...
  // CEO OS — Hypergrowth Operating Layer (docs/founder/INDEX.md)
  { key: "ceoOs", href: "/ceo-os", icon: Sparkles },
  { key: "founderLeverage", href: "/founder-leverage", icon: ClipboardList },
  { key: "capitalAllocation", href: "/capital-allocation", icon: BarChart3 },
  { key: "strategy", href: "/strategy", icon: GitBranch },
  { key: "dealDesk", href: "/deal-desk", icon: CheckSquare },
  { key: "enterpriseSales", href: "/enterprise-sales", icon: Building2 },
