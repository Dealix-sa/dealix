      ...
      >
        ...
        <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#001F3F] to-[#0a2040] px-8 py-14 text-white shadow-xl">
          <div className="relative space-y-5">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <Button asChild size="lg" className="bg-[#D4AF37] text-[#001F3F] hover:bg-[#C49A2E] font-bold shadow-lg">
                ...
                >
                  ...
                  <Button
                    ...
                    className={`mt-4 w-full text-xs ${
                      tier.highlight
                        ? "bg-[#D4AF37] text-[#001F3F] hover:bg-[#C49A2E]"
                        : ""
                    }`}
                  >
        ...
        <section className="text-center space-y-4">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Button asChild size="lg" className="bg-[#D4AF37] text-[#001F3F] hover:bg-[#C49A2E] font-bold">
              <Link href={`${base}/risk-score`}>
